...
/** 기본 — 값어치 비교(평년→작년→지난달 폴백) 기준 내렸다. ↓칩 + 큰 숫자 쪽빛. */
...
/** 스파크라인은 최근 궤적 [1달 전, 2주 전, 1주 전, 지금] 중 2개 이상의 점이 있을 때만 그려진다.
 *  이 스토리는 1달 전과 지금만 있으므로 2점 그래프가 표시된다. yearAgo·normalYear은
 *  궤적 점이 아니라 기준선·각주용이다(toSpark 함수 참고). */
