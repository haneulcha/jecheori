...
/** 기본 — 값어치 비교(지난 주→2주 전→지난달 폴백) 기준 내렸다. 기본 노브엔 지난달만 있어
 *  "지난달 대비". ↓칩 + 큰 숫자 쪽빛. */
...
/** 스파크라인은 궤적 [작년, 1달 전, 2주 전, 1주 전, 지금] 중 2개 이상의 점이 있을 때만 그려진다.
 *  이 스토리는 작년(yearAgo)까지 비워 1달 전·지금 2점만 남는다. normalYear은 궤적 점이 아니라
 *  평년 점선·범례용이다(toSpark 함수 참고). */
